...
class ChannelIndependentConv(nn.Module):
    ...
    def __init__(self, in_features, out_features, in_edges, out_edges=None):
        ...
        self.node_fc = nn.Linear(self.in_features, self.out_features, weight_attr=weight_attr_1, bias_attr=bias_attr_1)
        self.node_sfc = nn.Linear(self.in_features, self.out_features, weight_attr=weight_attr_2, bias_attr=bias_attr_2)
    ...
    def forward(self, A, emb_node, emb_edge, mode=1):
        if mode == 1:
            ...
            node_x = paddle.matmul(A.transpose(2, 3).transpose(1, 2),
